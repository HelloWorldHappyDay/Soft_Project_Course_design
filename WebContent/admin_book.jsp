...
<head>
    ...
    <script type="text/javascript" src = "static/js/AdminAddBook.js"></script>
    <script type="text/javascript" src = "static/js/AdminUpdateBook.js"></script>
</head>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="form-group">	
					<label for="firstname" class="col-sm-3 control-label">总数量</label>
					<div class="col-sm-7">
						<input type="num" class="form-control" id="addNum" required="required" name="num" placeholder="请输入图书总数量">
