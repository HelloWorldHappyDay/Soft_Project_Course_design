...
<head>
    ...
    <script type="text/javascript" src = "static/js/AdminAddBookType.js"></script>
    <script type="text/javascript" src = "static/js/AdminUpdateBookType.js"></script>
</head>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" onclick="updateBookType()" >修改</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal -->
			</div>	
			...
			<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
							<button type="button" class="btn btn-primary" onclick="addBookType()" >添加</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal -->
			</div>
