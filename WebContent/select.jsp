	    ...
	    <div class="row">
	        <div class="col-md-2 bootstrap-admin-col-left">
	            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
		             <li><a href="/books/select.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 图书查询</a></li>
			         <li><a href="/books/borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 借阅信息</a></li>
			         <li><a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 借阅历史</a></li>
	           	</ul>
	        </div>
	        <!-- content -->
	        <div class="col-md-10">   
	            	...
	            	<div class="col-lg-12">
	                	<table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
		                        ...
		                        <td><%= bean.getPress() %></td>  
		                        <td><%= bean.getNum() %></td>
								<td><button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="borrowbook(<%= bean.getBid() %>,<%= bean.getNum() %>,<%=admindao.getNotReturn(admin.getUsername()) %>,<%=admin.getMax_num() %>)" >借阅</button></td>
	                        </tbody>
	                        <%} %> 
	                    </table>
	                </div>
	    		...
	    		function borrowbook(bid,bnum,nRNum,MaxNum) {
	    			con=confirm("是否借阅?"); 
	    			if(con==true){
		    			if(bnum == 0){
		    				con1 = alert("余量为0，无法借阅");
		    			}
		    			else if(nRNum >= MaxNum){
		    				con2 = alert("已经超过可借阅数，无法借阅");
		    			}
		    			else{
